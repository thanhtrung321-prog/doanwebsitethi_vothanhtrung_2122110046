    ...
    <section class="hdl-maincontent py-2">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="image">
                        <img id="productimage" class="img-fluid w-100"
                            src="../public/images/product/thoi-trang-nam-1.jpg" alt="" />
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <a class="btn btn-main" href="checkout.phpindex.php">Mua ngay</a>
                            ...
                            <div class="product-item border">
                                <div class="product-item-image">
                                    <a href="product_detail.phpindex.php">
                                        <img src="../public/images/product/thoi-trang-nam-1.jpg" class="img-fluid"
                                            alt="" id="img1" />
                                        <img class="img-fluid" src="../public/images/product/thoi-trang-nam-2.jpg"
                                            alt="" id="img2" />
                                    </a>
                                </div>
