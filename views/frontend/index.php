                ...
                <div class="col-12 d-none d-md-block col-md-2 d-none d-md-block">
                    <div class="dropdown list-category">
                        ...
                        <ul class="dropdown-menu w-100">
                            <li>
                                <a class="dropdown-item" href="product_category.php">Thời trang nam</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="product_category.php">Thời trang nữ</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="product_category.php">Thời trang trẻ em</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/VOTHANHTRUNG_2122110046/public/images/banner/slider_1.jpg" class="d-block w-100"
                        alt="..." />
                </div>
                <div class="carousel-item">
                    <img src="/VOTHANHTRUNG_2122110046/public/images/banner/slider_2.jpg" class="d-block w-100"
                        alt="..." />
                </div>
                <div class="carousel-item">
                    <img src="/VOTHANHTRUNG_2122110046/public/images/banner/slider_3.jpg" class="d-block w-100"
                        alt="..." />
                </div>
            </div>
