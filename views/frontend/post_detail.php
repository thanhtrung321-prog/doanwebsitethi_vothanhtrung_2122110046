            ...
            <div class="row">
                ...
                <div class="col-md-9 order-1 order-md-2">
                    ...
                    <p>
                        ...
                        your headings change to match the new theme. Save time in Word
                        with new buttons that show up where you need them. To change the
                        way a picture fits in your document, click it and a button for
                    ...
                    <ul class="post-list-other">
                        <li><a href="post_detail.php">Tiêu đề bài viết 2</a></li>
                        <li><a href="post_detail.php">Tiêu đề bài viết 3</a></li>
                        <li><a href="post_detail.php">Tiêu đề bài viết 4</a></li>
                        <li><a href="post_detail.php">Tiêu đề bài viết 5</a></li>
                        <li><a href="post_detail.php">Tiêu đề bài viết 6</a></li>
                        <li><a href="post_detail.php">Tiêu đề bài viết 7</a></li>
                    </ul>
                </div>
            </div>
        </div>
