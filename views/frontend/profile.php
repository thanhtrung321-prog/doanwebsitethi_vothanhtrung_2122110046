        ...
        <div class="row">
            <div class="col-md-3 order-2 order-md-1">
                <ul class="list-group mb-3 list-category">
                    ...
                    <li class="list-group-item">
                        <a href="index.php?option=profile">Thời trang thể thao</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-9 order-1 order-md-2">
                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td><?= $customer->username; ?> <a href="index.php?option=profile-changepassword">Đổi mật
                                khẩu</a> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?= $customer->address; ?> <a href="index.php?option=profile-edit">Đổi địa chỉ</a> </td>
                    </tr>
                </table>
            </div>
        </div>
