    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="views/frontend/post_detail.php">
                            <img class="img-fluid" src="/PhamQuocDuy_2122110045/public/images/post/post-4.webp" />
                        </a>
                        ...
                        <p>Tieu đề bài viết mói nhất 1Tieu đề bài viết mói nhất 1Tieu đề bài viết mói nhất 1Tieu đề bài
                            viết mói nhất 1Tieu đề bài viết mói nhất 1Tieu đề bài viết mói nhất 1Tieu đề bài viết mói
                            nhất
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="views/frontend/post_detail.php">
                                    <img class="img-fluid"
                                        src="/PhamQuocDuy_2122110045/public/images/post/post-1.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="views/frontend/post_detail.php">
                                    <img class="img-fluid"
                                        src="/PhamQuocDuy_2122110045/public/images/post/post-2.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                                <h3 class="post-title fs-5">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="views/frontend/post_detail.php">
                                    <img class="img-fluid"
                                        src="/PhamQuocDuy_2122110045/public/images/post/post-3.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                                <h3 class="post-title fs-5">
