                ...
                <div class="col-md-3 order-2 order-md-1">
                    <ul class="list-group mb-3 list-page">
                        ...
                        <li class="list-group-item">
                            <a href="post_page.phpindex.php">Chính sách mua hàng</a>
                        </li>
                        <li class="list-group-item">
                            <a href="post_page.phpindex.php">Chính sách vận chuyển</a>
                        </li>
                        <li class="list-group-item">
                            <a href="post_page.phpindex.php">Chính sách đổi trả</a>
                        </li>
                        <li class="list-group-item">
                            <a href="post_page.phpindex.php">Chính sách bảo hành</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-9 order-1 order-md-2">
                    <h1 class="fs-2 text-main">Giới thiệu</h1>
                    <p>
