...
<style>
    .thanhtrung {
        background-image: url('https://antimatter.vn/wp-content/uploads/2022/05/hinh-nen-powerpoint.jpg');
    }

    .navbarleft {
        background-image: url('https://1.bp.blogspot.com/-KZeJkAOwkeE/YDUf0i6pL8I/AAAAAAAA8fE/bvGLkGdPq44PymBu14pS_iPc5lmnOjdhQCLcBGAsYHQ/s0/anh-nen-4k%2B%25283%2529.jpg');
...
<body class="hold-transition sidebar-mini thanhtrung">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light thanhtrung">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php?option=contact" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 navbarleft">
            <a href="../backend/index.php" class="brand-link">
                <img src="../public/dist/img/adminlogo.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">QUẢN TRỊ</span>
            </a>
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img style="border-radius: 50%;width:3rem;height:3rem;object-fit:cover;" src="../public/dist/img/imagelogouser.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
