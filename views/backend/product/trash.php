...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            <div class="row">
                <div class="col-md-6">
                    <a href="index.php?option=product&cat=trash" class="btn btn-danger btn-xs"><i
                                ...
                                <tr class="datarow">
                                    ...
                                    <td>
                                        ...
                                        <div class="function_style">
                                            <a href="index.php?option=product&cat=restore&id=<?= $item->id; ?>"
                                                class="btn btn-info btn-xs">
                                                <i class="fas fa-undo"></i></i>Khôi phục
                                            </a> |
                                            <a href="index.php?option=product&cat=destroy&id=<?= $item->id; ?>"
